...
// configuration step. It creates a namespace called `Tclang`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", Tclang::cmake::project_name, Tclang::cmake::project_version) };
